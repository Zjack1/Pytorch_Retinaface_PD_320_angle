...
import datetime
import math
from nets.retinaface_rpn_net_V4x320_conv_fc import Retinaface_Angle_Net
...
parser.add_argument('--train_img_path', default='../train_retinaface_27w_rpy/img_shake_27w/', help='training image path')
parser.add_argument('--training_dataset', default='../train_retinaface_27w_rpy/train_shake_27w_25_landmark_pry_list.txt', help='Training dataset directory')
parser.add_argument('--network', default='mobile0.25', help='Backbone network mobile0.25 or resnet50')
parser.add_argument('--num_workers', default=0, type=int, help='Number of workers used in dataloading')
parser.add_argument('--lr', '--learning-rate', default=1e-4, type=float, help='initial learning rate')
parser.add_argument('--momentum', default=0.9, type=float, help='momentum')
parser.add_argument('--resume_net', default="./weights/27w_conv_fc/angle_V4_conv_data2_mseloss_epoch_12.pth", help='resume net for retraining')
parser.add_argument('--resume_epoch', default=0, type=int, help='resume iter for retraining')
parser.add_argument('--weight_decay', default=1e-5, type=float, help='Weight decay for SGD')
parser.add_argument('--gamma', default=0.1, type=float, help='Gamma update for SGD')
parser.add_argument('--save_folder', default='./weights/27w_conv_fc/', help='Location to save checkpoint models')
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            if (epoch % 2 == 0 and epoch > 0) or (epoch % 5 == 0 and epoch > cfg['decay1']):
                torch.save(net.state_dict(), save_folder + 'Angle_V4x320_conv_fc_27w_epoch_' + str(epoch) + '.pth')
            epoch += 1
