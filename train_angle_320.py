...
import datetime
import math
from nets.retinaface_rpn_net_V4x320_conv import Retinaface_Angle_Net
...
parser.add_argument('--resume_net', default="./weights/data2_conv/angle_V4_conv_data2_mseloss_epoch_12.pth", help='resume net for retraining')
parser.add_argument('--resume_epoch', default=0, type=int, help='resume iter for retraining')
parser.add_argument('--weight_decay', default=5e-5, type=float, help='Weight decay for SGD')
parser.add_argument('--gamma', default=0.1, type=float, help='Gamma update for SGD')
parser.add_argument('--save_folder', default='./weights/data2_conv/', help='Location to save checkpoint models')
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            if (epoch % 2 == 0 and epoch > 0) or (epoch % 5 == 0 and epoch > cfg['decay1']):
                torch.save(net.state_dict(), save_folder + 'angle_V4_conv_data2_mseloss_epoch_' + str(epoch) + '.pth')
            epoch += 1
