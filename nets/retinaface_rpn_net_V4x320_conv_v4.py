...
class Angle(nn.Module):
    def __init__(self,roi_size=80, spatial_scale=1):
        ...
        self.conv9 = conv_bn(32, 32, 1)
        self.conv10 = conv_bn(32, 32, 2)
    ...
    def forward(self, x, rois, roi_indices, img_size):
        ...
        out11 = self.max_pool(out10)
        out12 = out11.view(out11.size(0), -1)
        out13 = self.fc1(out12)
