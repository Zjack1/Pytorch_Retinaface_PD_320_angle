...
import cv2
from nets.retinaface_net_V4x320 import RetinaFace
from utils.box_utils import decode, decode_landm_25,draw_landmark_line

import time

parser = argparse.ArgumentParser(description = 'Retinaface')
parser.add_argument('--trained_model', default='./weights/V4_320_130w/V4_320_epoch_new_lr_5.pth',
...
if __name__ == '__main__':
    ...
    for line in lines:
        ...
        tic = time.time()
        loc, conf, landmark = net(img)  # forward pass
        ...
        if 0:
            GT_landmark_draw_x = GT_landmark[::2]
            GT_landmark_draw_y = GT_landmark[1::2]
            for landmk2 in range(25):
                cv2.circle(img_raw, (GT_landmark_draw_x[landmk2], GT_landmark_draw_y[landmk2]), 1, (0, 255, 1), 4)
            img_raw = draw_landmark_line(img_raw, GT_landmark_draw_x, GT_landmark_draw_y,(0, 255, 1))
