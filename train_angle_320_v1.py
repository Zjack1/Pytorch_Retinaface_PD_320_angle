...
import datetime
import math
from nets.retinaface_rpn_net_V4x320_conv_v1 import Retinaface_Angle_Net
...
parser.add_argument('--save_folder', default='./weights/27w_conv_v1/', help='Location to save checkpoint models')
    ...
    for iteration in range(start_iter, max_iter):
        if iteration % epoch_size == 0:
            ...
            if (epoch % 2 == 0 and epoch > 0) or (epoch % 5 == 0 and epoch > cfg['decay1']):
                torch.save(net.state_dict(), save_folder + 'Angle_V4_conv_v1_27w_epoch_' + str(epoch) + '.pth')
            epoch += 1
